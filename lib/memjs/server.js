...
Server.prototype.respond = function(response) {
  // console.log("YOO")
  // throw new ("EROOR")
  const seq = response.split(" ")[1]
  // console.log(this.responseCallbacks)
  console.log(seq.trim())
  // console.log(response)
  // console.log('this.responseCallbacks.length')
  // console.log(this.responseCallbacks)
  console.log(this.responseCallbacks[seq.trim().toString()])
  // console.log(this.responseCallbacks["01"])
  // for(let data of Object.values(this.responseCallbacks)){
  //   console.log(data)
  //   console.log(data)
  // }
// console.log(this.responseCallbacks["seq"])
  ...
  for (const [key, value] of Object.entries(this.responseCallbacks)) {
  ...
  callback(response);
  if (!callback.quiet) {
    delete(this.responseCallbacks[seq]);
    this.requestTimeouts.shift();
    delete(this.errorCallbacks[seq]);
  }
};
