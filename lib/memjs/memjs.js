...
Client.prototype.gets = function(key, callback) {
  ...
  // var request = makeASCIIRequest(key.join(" "));
  // let request = "gets " + key.join(" ")+"\r\n"
  ...
  // console.log(request)
  // let request = "gets " + key.join(" ")+"\r\n"
  // let request = "gets user_868a976e-de82-405e-b8d3-b03c9d00e27d\r\n"

  // console.log("gets " + key.join(" "))
  // var request = makeRequestBuffer(0, key.join(" "), '', '', this.seq);
  ...
  var errorHandler = function(error) {
    if (--retries > 0) {
      ...
      if (failover) {
        ...
        _this.perform(key, request, seq, func, callback, origRetries, func);
      } else {
